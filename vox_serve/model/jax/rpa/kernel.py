...
from .util import align_to, cdiv, get_dtype_packing, get_tpu_version, next_power_of_2
...
def _ragged_paged_attention_kernel_loop(
    ...
    bkv_update_ids_ref,  # [6] (bkv_sem_0_seq_idx, bkv_sem_1_seq_idx, bkv_sem_0/1_offset, bkv_sem_0/1_sz)  # noqa: E501
    # Input
