# https://github.com/huggingface/transformers/blob/v4.52.3/src/transformers/models/llama/modeling_llama.py
...
def orpheus_format_prompt(prompt, voice="tara", model_type="larger"):
